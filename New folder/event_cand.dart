...
import 'calender_doctor/view3.dart';

class EventCalend extends StatefulWidget {
  const EventCalend({Key? key}) : super(key: key);

  @override
  State<EventCalend> createState() => _EventCalendState();
}

class _EventCalendState extends State<EventCalend> {
  bool _flag1 = true;
  bool _flag2 = true;
  bool _flag3 = true;
  bool _flag4 = true;
                                  ...
                                  child: Column(
                                      ...
                                      children: [
                                        ...
                                        Padding(
                                          ...
                                          child: Text(
                                              "Appointment sucessfully Changed you will recieve a notifecation and the doctor \nwill contact you."
                                                  .tr,
                                              style: TextStyle(
                                                  fontSize: 16,
                                                  fontWeight:
