...
class EventCalendarScreen1 extends StatefulWidget {
  const EventCalendarScreen1({Key? key}) : super(key: key);

  @override
  State<EventCalendarScreen1> createState() => _EventCalendarScreen1State();
}

class _EventCalendarScreen1State extends State<EventCalendarScreen1> {
  bool _flag1 = true;
  bool _flag2 = true;
  bool _flag3 = true;
  bool _flag4 = true;
